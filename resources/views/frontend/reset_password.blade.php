...
<div class="login_wrapper">
	<div class="animate form login_form">
		<section class="login_content"> 
			...
			<form method="post" name="UserForgotPasswordForm" id="UserForgotPasswordForm" class="login-form" action="{{route('reset-password-submit')}}">   
...
<div>
<input name="data[password]" class="form-control placeholder-no-fix" placeholder="Password" autocomplete="off" onkeyup="passwordCheck(this.value);" type="password" /> </div>
<div>
...
<p></p>
<p>� 2023 Fortress Fund Managers Ltd. All Rights Reserved.</p>
</div>
</div>
<div id="pswd_info">
